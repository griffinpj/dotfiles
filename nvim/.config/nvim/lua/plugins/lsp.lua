    ...
    -- LSP
    {
        ...
        config = function()
            ...
            lsp_zero.on_attach(function(client, bufnr)
                ...
                vim.keymap.set("n", "<leader>vws", function() vim.lsp.buf.workspace_symbol() end, { desc = 'Query symbols' })
                vim.keymap.set("n", "<leader>vd", function() vim.diagnostic.open_float() end, { desc = 'Open diagnostics' })
